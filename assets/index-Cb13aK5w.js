 ...
 <div class="pl-5">
  ...
  <div class="flex pr-5">
    <a class="p-[15px] flex gap-7 hover:bg-[#23252b] hover:rounded-[8px]">
      ...
      <div class="h-fit">Download Battle.net</div>
    </a>
    <a class="flex p-[15px] gap-2 hover:bg-[#23252B] hover:rounded-[8px]">
      <svg
        class="w-[24px] h-[24px] fill-[#808184]"
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
    ...
    <div
      class="flex gap-2 relative z-10 hover:bg-[#23252B] hover:rounded-[8px] group drop-shadow-2xl"
    >
      <div
        class="w-[300px] p-4 rounded-[6px] group-hover:inline-block hidden bg-[#15171E] absolute top-16 right-0"
      >
        <a
          class="bg-blue-600 hover:bg-blue-400 justify-center text-2xl flex p-3 rounded-[6px]"
        >
          log In
        </a>
      ...
      <div class="flex gap-2 rounded-2xl hover:bg-[#23252b] p-5">
        <svg
          class="w-[24px] h-[24px] fill-[#808184]"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor "
   ...
   <!-- header-3-->
 </nav>`,y=(...s)=>{s.forEach(e=>{document.querySelector("#root").insertAdjacentHTML("beforeend",e)})},g=`<div class="w-fit h-[50px]  p-3">
         
    
     <!-- header-bottom -->
    <div
      class="w-full h-[80px] bg-[#15171E] gap-2 justify-evenly items-center p-2 sm:hidden  xl:flex  "
    >
      <div
        class="w-[953px] h-full bg-[#23252B] sm:hidden  xl:hidden lg:flex  rounded-[6px] 2xl:flex gap-6 pl-4 text-white  z-999"
      >
      ...
      <div
        class="sm:w-full  sm:flex  xl:w-full   2xl:w-[353px] h-full bg-[#23252B]  rounded-[6px] p-[18px] gap-3 text-white">
        <svg
        ...
        <h2 class="lg:hidden  2xl:flex  xl:text-[13px]">Search Shop</h2>
      </div>
      <div
      class="lg:flex lg:w-[200px] 2xl:w-[180px] h-full bg-[#23252B] rounded-[6px] sm:hidden  2xl:flex justify-evenly items-center text-white desktop:text-[14px]   group relative"
    >
      ...
      `,f=()=>{let s=[...document.querySelectorAll(".slide")],e=0,a=document.querySelector("#sliderbullets"),l=s.map((r,i)=>`<span class="bullet" data-id="${i}"> </span> `);a.insertAdjacentHTML("afterbegin",l.join("")),[...document.querySelectorAll(".bullet")].forEach(r=>{r.addEventListener("click",i=>{e=i.target.dataset.id,t(e),i.target.classList.add("active")})});let t=r=>{s.forEach((i,x)=>{i.style.left=`${(x-r)*100}% `}),document.querySelectorAll(".bullet").forEach((i,x)=>{i.classList.remove("active"),e===x&&i.classList.add("active")})};t(e);let c=document.querySelector("#prevbtn"),p=document.querySelector("#nextbtn"),o=()=>{e===0?(e=s.length-1,t(e)):(e--,t(e))},d=()=>{e===s.length-1?(e=0,t(e)):(e++,t(e))};c.addEventListener("click",()=>{d()}),p.addEventListener("click",()=>{o()}),document.addEventListener("keyup",r=>{r.key==="ArrowRight"?o():r.key==="ArrowLeft"&&d()});let v=!0,h=setInterval(()=>{o()},3e3);document.querySelector("#interval").addEventListener("click",()=>{v?(clearInterval(h),v=!1,document.querySelector("#interval").innerHTML=`<svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<path id="XMLID_675_" d="M69.5,42.9l-42-33c-1.2-0.9-2.8-1.1-4.2-0.5C21.9,10.1,21,11.5,21,13v66c0,1.5,0.9,2.9,2.3,3.6
	...
	/>
</svg>`):(h=setInterval(()=>{o()},3e3),v=!0)})},u=` <div class="w-full h-[400px] xl:flex xl:flex-row sm:flex-row-reverse justify-around xl:items-center relative ">
      
       
      
      <img src="https://blz-contentstack-images.akamaized.net/v3/assets/bltf408a0557f4e4998/blt33881df85a125c99/645a6b18a3a6d365a5b032fb/mobile-bg-lg_3.png?imwidth=912&imdensity=1.25" alt="" class="sm:hidden object-cover lg:w-full   object-center xl:flex absolute top-0">
      
      
      <img src="https://blz-contentstack-images.akamaized.net/v3/assets/bltf408a0557f4e4998/blt13471a215fdd353b/64ee7e08c0047107f1fa2fd7/laptop-optimized.png?imwidth=912&imdensity=1.25" alt="" class="w-[280px] h-[160px] object-cover object-center relative top-[100px]">
      <div class="xl:w-[470px] sm:w-[300px] h-full relative  top-[100px] sm:text-[10px] xl:text-[16px]">
        <p  class="lg:w-[470px] h-[60px] text-white lg:text-[40px] ml:text-[20px] sm:text-[10px]">Dive into adventure</p>
        <p class="lg:w-[510px] h-[70px] text-slate-400 lg:font-[50px] ml:font-[30px] ml:text-[18px]">Download Battle.net and join a community of millions.</p>
        <div class="flex gap-3  sm:pb-4" >
      ...
      <p class="text-slate-200 lg:p-5 lg:font-[8px]">Also available for <span class="underline llg:leading-[100px] sm:leading-0 text-blue-500">Mac</span> and <span class="underline text-blue-500">mobile</span></p>
      </div>
    </div>`,b=`// let rightOpen = document.querySelector("#rightOpen");
let leftOpen = document.querySelector("#leftOpen");
// let rightMenu = document.querySelector("#rightMenu");
let leftMenu = document.querySelector("#leftMenu");
let leftClose = document.querySelector("#leftClose"); 
...
// });
// console.log(btn)
`,n=(...s)=>{s.forEach(e=>{document.querySelector("#root").insertAdjacentHTML("beforeend",e)})},M=`<div class="w-full p-5 font-extrabold text-white ">recommends</div>
 <div id="recommendsContainer"
      class="w-full pb-6 grid gap-4 [&>*]:bg-slate-900 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
 </div>
`;n(M);let C=async()=>{let a=(await(await fetch("http://localhost:3000/recommend")).json()).map(l=>`<div class="flex flex-col gap-2 relative ">
          
          
            <img src="${l.image}" class="w-full h-[160px] object-cover object-center"
             alt=""/>
             <div class=" hover:pl-2  hover:bg-slate-800 ">
             <div class="w-full flex-col gap-4  items-center">
             <div  class="ng-star-inserted  p-4 text-white ">${l.gameName} 
             <div class="text-slate-400 ">${l.gameTitle}
              <div  class="w-[200px] text-yellow-600 font-[7px]">${l.desc}</div>
            <div  class="pt-4 text-white">Massively Multiplayer RPG</div>
         <div class="text-slate-600 pt-3">${l.price}</div>
            </div>
          </div>    
          </div>
</div>        
      </div>`);document.querySelector("#recommendsContainer").insertAdjacentHTML("afterbegin",a.join(""))};C();let z=`
<div class="w-full p-5 font-extrabold text-white ">Featured</div><div id="FeaturedContainer"
      class="w-full pb-6 grid gap-4 [&>*]:bg-slate-900 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
 </div>

`;n(z);let B=async()=>{let a=(await(await fetch("http://localhost:3000/Featured")).json()).map(l=>` 
        <div class="flex flex-col gap-2 relative ">
          ...
          <div class="w-full flex-col gap-4  items-center">
            <img src="${l.image}" class="w-full h-[160px] object-cover object-center"
             ...
             <div  class="ng-star-inserted  p-4 text-white">${l.gameName} 
             <div class="text-slate-400">${l.gameTitle}
              <div  class=" text-yellow-600">${l.desc}</div>
            <div  class="pt-4 text-white">Massively Multiplayer RPG</div>
         <div class="text-slate-600 pt-3">${l.price}</div>
            </div>
          </div>    
      ...
      </div>`);document.querySelector("#FeaturedContainer").insertAdjacentHTML("afterbegin",a.join(""))};B();let k=`<div class="w-full p-5 font-extrabold text-white ">Trending Now</div>
 <div id="TrendingNowContainer"
      class="w-full pb-6 grid gap-4 [&>*]:bg-slate-900 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
 </div>
`;n(k);let L=async()=>{let a=(await(await fetch("http://localhost:3000/Trending Now")).json()).map(l=>` 
        <div class="flex flex-col gap-2 relative ">
      ...
      </div>`);document.querySelector("#TrendingNowContainer").insertAdjacentHTML("afterbegin",a.join(""))};L();let H=`<div class="w-full  p-5 font-extrabold text-white ">MostGifted</div>
 <div id="MostGiftedContainer"
      class="w-full  pb-6 grid gap-4 [&>*]:bg-slate-900 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
 </div>
 `;n(H);let F=async()=>{let a=(await(await fetch("http://localhost:3000/Most Gifted")).json()).map(l=>` 
        <div class="flex flex-col  flex-wrap gap-2 relative  ">
      ...
      </div>`);document.querySelector("#MostGiftedContainer").insertAdjacentHTML("afterbegin",a.join(""))};F();const m=cardApi;y(w,g,b,f,m,u);g();w();f();m();u();
